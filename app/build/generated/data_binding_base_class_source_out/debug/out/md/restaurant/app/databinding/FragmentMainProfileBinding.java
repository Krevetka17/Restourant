...
public final class FragmentMainProfileBinding implements ViewBinding {
  ...
  private FragmentMainProfileBinding(@NonNull SwipeRefreshLayout rootView,
      @NonNull Button btnAdminPanel, @NonNull ImageButton btnCopyId, @NonNull Button btnEditProfile,
      @NonNull Button btnLogout, @NonNull Button btnMyOrders, @NonNull Button btnNotifications,
      @NonNull Button btnPaymentData, @NonNull Button btnPendingReviews,
      @NonNull ImageView ivAvatar, @NonNull SwipeRefreshLayout swipeRefresh,
  ...
  public static FragmentMainProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMainProfileBinding((SwipeRefreshLayout) rootView, btnAdminPanel, btnCopyId,
          btnEditProfile, btnLogout, btnMyOrders, btnNotifications, btnPaymentData,
          btnPendingReviews, ivAvatar, swipeRefresh, tvUserEmail, tvUserId, tvUserName);
    }
