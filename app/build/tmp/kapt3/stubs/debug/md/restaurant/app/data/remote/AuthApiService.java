...
public abstract interface AuthApiService {
    ...
    @retrofit2.http.DELETE(value = "payment-methods/{pmId}")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object deletePaymentMethod(@retrofit2.http.Path(value = "pmId")
    @org.jetbrains.annotations.NotNull()
    java.lang.String pmId, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super md.restaurant.app.data.remote.dto.PaymentMethodsResponse> $completion);
    ...
    @retrofit2.http.POST(value = "notify-admin-payment")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object notifyAdminAboutPayment(@retrofit2.http.Body()
    @org.jetbrains.annotations.NotNull()
    java.util.Map<java.lang.String, java.lang.String> body, @org.jetbrains.annotations.NotNull()
